...
#include "machine/db/eflags.h"		/* from Mach... */
/* #include <i386/trap.h> */
...
extern db_expr_t db_get_value(db_addr_t addr, int size, boolean_t is_signed);
extern void	 db_put_value(db_addr_t addr, int size, db_expr_t value);
