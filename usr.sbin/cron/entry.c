 ...
 */
entry *
load_entry(FILE *file, void (*error_func)(void), struct passwd *pw, char **envp)
{
...
static int
set_element(bitstr_t *bits /* one bit per flag, default=FALSE */, int low, int high, int number)
{
