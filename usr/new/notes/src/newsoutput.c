...
#ifdef	pdp11
#define	gatesysnames _gtsysn
#define	gatesyscount _gtsysc
#endif

#ifdef	RCSIDENT
static char rcsid[] = "$Header: /usr/local/src/usenet/notes/src/RCS/newsoutput.c,v 1.8 88/11/11 00:59:03 paul Exp $";
#endif	RCSIDENT
...
char  **argv;
{
...
#ifdef	SYSLOG
    openlog ("newsoutput", LOG_PID, SYSLOG);
#endif	SYSLOG
    ...
    getnet (RNEWSNAME, NULL, &how);			/* how to get there */
    if (how.nh_xmit != (char *) NULL)			/* specified? */
	strcpy (rnewscmd, how.nh_xmit);			/* load it */
