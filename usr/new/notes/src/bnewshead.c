...
static char *RCSid = "$Header: /usr/local/src/usenet/notes/src/RCS/bnewshead.c,v 2.20 88/10/03 15:34:46 paul Exp Locker: paul $";
#endif	RCSIDENT
...
register struct hbuf   *hp;
{
    ...
    {
#ifdef	SYSLOG
	syslog (LOG_INFO, "Bizzaro header line: %s\n", bfr);
#else
