...
static u_int32_t gen_mask(u_int32_t x)
{
	u_int32_t  m;
...
void mars_encrypt(mars_ctx *ctx, const u_int8_t in_blk[4], u_int8_t out_blk[4])
{
	u_int32_t  a, b, c, d, l, m, r;
	u_int32_t *l_key;
