...
struct ufs211_statfs {
	...
	ufs211_daddr_t			f_blocks;						/* total data blocks in file system */
	ufs211_daddr_t			f_bfree;						/* free blocks in fs */
	ufs211_daddr_t			f_bavail;						/* free blocks avail to non-superuser */
	ufs211_ino_t			f_files;						/* total file nodes in file system */
	ufs211_ino_t			f_ffree;						/* free file nodes in fs */
...
struct ufs211_mount {
	...
	ufs211_dev_t	    	m_dev;		    				/* device mounted */
