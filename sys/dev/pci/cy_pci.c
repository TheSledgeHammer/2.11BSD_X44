...
static int cy_match_pci (struct device *, void *, void *);
#else
static int cy_match_pci (struct device *, struct cfdata *, void *);
#endif
static void cy_attach_pci  (struct device *, struct device *, void *);
static int cy_map_pci (struct pci_attach_args *, bus_space_tag_t *,
    bus_space_handle_t *, bus_size_t  *, bus_space_tag_t *,
    bus_space_handle_t *, bus_size_t *);
static void cy_unmap_pci (bus_space_tag_t, bus_space_handle_t, bus_size_t, bus_space_tag_t, bus_space_handle_t, bus_size_t);
