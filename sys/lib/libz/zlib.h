...
ZEXTERN int ZEXPORT deflateTune __P((z_streamp strm,
                                    int good_length,
                                    int max_lazy,
                                    int nice_length,
                                    int max_chain));
...
ZEXTERN uLong ZEXPORT deflateBound __P((z_streamp strm,
                                       uLong sourceLen));
/*
...
ZEXTERN int ZEXPORT deflatePrime __P((z_streamp strm,
                                     int bits,
                                     int value));
/*
...
ZEXTERN int ZEXPORT deflateSetHeader __P((z_streamp strm,
                                         gz_headerp head));
/*
...
ZEXTERN int ZEXPORT inflateCopy __P((z_streamp dest,
                                    z_streamp source));
/*
     Sets the destination stream as a complete copy of the source stream.
...
ZEXTERN int ZEXPORT inflatePrime __P((z_streamp strm,
                                     int bits,
                                     int value));
/*
...
ZEXTERN int ZEXPORT inflateGetHeader __P((z_streamp strm,
                                         gz_headerp head));
/*
...
/*
ZEXTERN int ZEXPORT inflateBackInit __P((z_streamp strm, int windowBits,
...
typedef unsigned (*in_func) __P((void FAR *,
                                z_const unsigned char FAR * FAR *));
typedef int (*out_func) __P((void FAR *, unsigned char FAR *, unsigned));

ZEXTERN int ZEXPORT inflateBack __P((z_streamp strm,
...
ZEXTERN int ZEXPORT inflateBackEnd __P((z_streamp strm));
/*
...
ZEXTERN uLong ZEXPORT zlibCompileFlags __P((void));
...
ZEXTERN uLong ZEXPORT compressBound __P((uLong sourceLen));
/*
...
ZEXTERN int ZEXPORT    gzungetc __P((int c, gzFile file));
/*
...
ZEXTERN int ZEXPORT gzdirect __P((gzFile file));
/*
...
ZEXTERN void ZEXPORT gzclearerr __P((gzFile file));
/*
...
ZEXTERN uLong ZEXPORT adler32_combine __P((uLong adler1, uLong adler2,
                                          z_off_t len2));
/*
...
ZEXTERN uLong ZEXPORT crc32_combine __P((uLong crc1, uLong crc2, z_off_t len2));
...
ZEXTERN int ZEXPORT inflateInit2_ __P((z_streamp strm, int  windowBits,
                                      const char *version, int stream_size));
ZEXTERN int ZEXPORT inflateBackInit_ __P((z_streamp strm, int windowBits,
                                         unsigned char FAR *window,
                                         const char *version,
                                         int stream_size));
