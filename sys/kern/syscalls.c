...
char *syscallnames[] = {
	...
	"setegid",			/* 50 = setegid */
	"acct",			/* 51 = acct */
	"#52",		/* 52 = obsolete old phys */
	"#53",		/* 53 = obsolete old lock */
	"ioctl",			/* 54 = ioctl */
	"reboot",			/* 55 = reboot */
	"sigwait",			/* 56 = sigwait */
	"symlink",			/* 57 = symlink */
	...
	"#108",		/* 108 = obsolete old sigvec */
	"#109",		/* 109 = obsolete old sigblock */
	"#110",		/* 110 = obsolete old sigsetmask */
	"#111",		/* 111 = obsolete old sigpause */
