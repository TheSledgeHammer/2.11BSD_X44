...
char *syscallnames[] = {
	...
	"#87 (obsolete old gethostname)",		/* 87 = obsolete old gethostname */
	"#88 (obsolete old sethostname)",		/* 88 = obsolete old sethostname */
	...
	"#126 (obsolete old setreuid)",		/* 126 = obsolete old setreuid */
	"#127 (obsolete old setregid)",		/* 127 = obsolete old setregid */
	"rename",			/* 128 = rename */
